...
namespace Anima2D
{
    public class EditorExtra
    {
        ...
        public static bool IsProSkin()
        {
            ...
            PropertyInfo prop =
                typeof(EditorGUIUtility).GetProperty("isProSkin", BindingFlags.Static | BindingFlags.NonPublic);
        ...
        {
            MethodInfo methodInfo = typeof(EditorWindow).Assembly.GetType("UnityEditor.SceneViewPicking")
