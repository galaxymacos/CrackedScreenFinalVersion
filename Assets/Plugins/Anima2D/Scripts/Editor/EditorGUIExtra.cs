...
namespace Anima2D
{
    public class EditorGUIExtra
    {
        ...
        public static void SortingLayerField(GUIContent label, SerializedProperty layerID, GUIStyle style,
            GUIStyle labelStyle)
        {
            MethodInfo methodInfo = typeof(EditorGUILayout).GetMethod("SortingLayerField",
            ...
            GUIStyle rightButton, bool horiz)
        {
            ...
            MethodInfo minMaxScrollerMethod =
        ...
        public static GUIContent TempContent(string t)
        {
            ...
            MethodInfo tempContentMethod = editorGUIUtilityType.GetMethod("TempContent",
        ...
        public static int GetPermanentControlID()
        {
            ...
            MethodInfo getPermanentControlIDMethod = guiUtilityType.GetMethod("GetPermanentControlID",
