...
namespace Anima2D
{
    public class AnimationWindowImpl_51_52_53 : IAnimationWindowImpl
    {
        ...
        protected Type m_AnimationWindowStateType =
            typeof(EditorWindow).Assembly.GetType("UnityEditorInternal.AnimationWindowState");

        protected Type m_AnimationWindowUtilityType =
            typeof(EditorWindow).Assembly.GetType("UnityEditorInternal.AnimationWindowUtility");

        protected Type m_AnimationWindowCurveType =
            typeof(EditorWindow).Assembly.GetType("UnityEditorInternal.AnimationWindowCurve");

        protected Type m_AnimationKeyTimeType =
            typeof(EditorWindow).Assembly.GetType("UnityEditorInternal.AnimationKeyTime");
        ...
        public virtual void InitializeReflection()
        {
            ...
            m_AnimEditorField =
                m_AnimationWindowType.GetField("m_AnimEditor", BindingFlags.Instance | BindingFlags.NonPublic);
            m_StateField = m_AnimEditorType.GetField("m_State", BindingFlags.Instance | BindingFlags.NonPublic);
            m_AllCurvesCacheField =
                m_AnimationWindowStateType.GetField("m_AllCurvesCache", BindingFlags.Instance | BindingFlags.NonPublic);

            m_FrameProperty = m_AnimationWindowStateType.GetProperty("frame",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
            m_RecordingProperty = m_AnimationWindowStateType.GetProperty("recording",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
            m_ActiveAnimationClipProperty = m_AnimationWindowStateType.GetProperty("activeAnimationClip",
                BindingFlags.Instance | BindingFlags.Public);
            m_ActiveGameObjectProperty =
                m_AnimationWindowStateType.GetProperty("activeGameObject", BindingFlags.Instance | BindingFlags.Public);
            m_ActiveRootGameObjectProperty = m_AnimationWindowStateType.GetProperty("activeRootGameObject",
                BindingFlags.Instance | BindingFlags.Public);
            m_RefreshProperty = m_AnimationWindowStateType.GetProperty("refresh",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
            m_CurrentTimeProperty =
                m_AnimationWindowStateType.GetProperty("currentTime", BindingFlags.Instance | BindingFlags.Public);
            m_PlayingProperty =
                m_AnimationWindowStateType.GetProperty("playing", BindingFlags.Instance | BindingFlags.Public);
            m_BindingProperty =
                m_AnimationWindowCurveType.GetProperty("binding", BindingFlags.Instance | BindingFlags.Public);
            ...
            m_CreateDefaultCurvesMethod = m_AnimationWindowUtilityType.GetMethod("CreateDefaultCurves",
                BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);

            Type[] l_AddKeyframeToCurveTypes =
                {m_AnimationWindowStateType, m_AnimationWindowCurveType, m_AnimationKeyTimeType};
            m_AddKeyframeToCurveMethod = m_AnimationWindowUtilityType.GetMethod("AddKeyframeToCurve",
                BindingFlags.Public | BindingFlags.Static, null, l_AddKeyframeToCurveTypes, null);

            Type[] l_SaveCurveTypes = {m_AnimationWindowCurveType};
            m_SaveCurveMethod = m_AnimationWindowStateType.GetMethod("SaveCurve",
                BindingFlags.Public | BindingFlags.Instance, null, l_SaveCurveTypes, null);
        }
        ...
        public virtual void AddKey(EditorCurveBinding binding, float time)
        {
            ...
            if (l_curves != null)
            {
                ...
                {
                    object[] parameters =
                        {state, l_animationWindowCurve, AnimationKeyTime(time, activeAnimationClip.frameRate)};
