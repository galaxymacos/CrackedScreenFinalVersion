...
namespace Anima2D
{
    ...
    public class OnionLayerManager
    {
        ...
        public void UpdateOnionLayers(AnimationClip clip, int frame, int offset, int step, float alphaMultiplier,
            Color colorPrevFrames, Color colorNextFrames)
        {
            ...
            int frameCount = (int) (AnimationWindowExtra.activeAnimationClip.length *
