...
namespace Anima2D
{
    public class OnionSkinWindow : EditorWindow
    {
        ...
        [SerializeField] float m_AlphaMultiplier = 1f;

        [SerializeField] int m_Step = 1;

        [SerializeField] int m_NumFrames = 15;

        [SerializeField] Color m_ColorPrevFrames = Color.red;

        [SerializeField] Color m_ColorNextFrames = Color.green;

        [SerializeField] bool m_EnableOnionSkin = true;

        [SerializeField] GameObject m_InstanceRoot;
        ...
        int clampedFrame
        {
            get { return Mathf.Clamp(AnimationWindowExtra.frame, 0, frameCount); }
        }
        ...
        void CreatePreview()
        {
            ...
            m_InstanceRoot =
                EditorExtra.InstantiateForAnimatorPreview(AnimationWindowExtra.rootGameObject) as GameObject;
