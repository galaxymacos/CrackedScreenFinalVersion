...
namespace Anima2D
{
    public class ContextMenu
    {
        ...
        static bool ValidateCreateSpriteMesh(MenuCommand menuCommand)
        {
            ...
            List<Texture2D> selectedTextures = Selection.objects.ToList().Where(o => o is Texture2D).ToList()
        ...
        static Vector3 GetDefaultInstantiatePosition()
        {
            ...
            if (SceneView.lastActiveSceneView)
            {
                ...
                {
                    PropertyInfo prop = typeof(SceneView).GetProperty("cameraTargetPosition",
